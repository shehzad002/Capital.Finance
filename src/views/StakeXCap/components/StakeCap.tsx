...
const StakeCap: React.FC<StakeProps> = ({}) => {
  const tokenName = "CAP"
  ...
  const tokenBalance = useTokenBalance(contractAddresses.cap[3])
      ...
      <CardContent>
        <StyledCardContentInner>
          <StyledCardHeader>
            ...
            <Label text={`CAP Tokens Available`}/>
          </StyledCardHeader>
          <StyledCardActions>
            {!allowance.toNumber() ? (
              <Button
